...
public class Match {
	...
	public Match(int matchId, String teamHeading, String matchNumberVenue, String batTeam, String batTeamScore,
	...
	// set status according to textComplete
	...
	public String toString() {
		return "Match [matchId=" + matchId + ", teamHeading=" + teamHeading + ", matchNumberVenue=" + matchNumberVenue
				+ ", batTeam=" + batTeam + ", batTeamScore=" + batTeamScore + ", bowlTeam=" + bowlTeam
